    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(blank=True, choices=[('IT', 'IT'), ('CS', 'CS'), ('AI/ML', 'AI/ML'), ('IOT', 'IOT')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('college_name', models.CharField(choices=[('GNIOT', 'GNIOT'), ('GIMS', 'GIMS')], max_length=120)),
                ('department', models.CharField(choices=[('IT', 'IT'), ('CS', 'CS'), ('AI/ML', 'AI/ML'), ('IOT', 'IOT')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.CharField(choices=[('B.Tech', 'B.Tech')], max_length=120)),
                ('department', models.CharField(choices=[('IT', 'IT'), ('CS', 'CS'), ('AI/ML', 'AI/ML'), ('IOT', 'IOT')], max_length=20)),
            ],
            options={
                'ordering': ['number'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.CharField(blank=True, max_length=120, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CourseOutcome',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('message', models.CharField(choices=[('TABLE_EDIT_ACCESS', 'TABLE_EDIT_ACCESS'), ('USER_LOGIN_ACCESS', 'USER_LOGIN_ACCESS')], max_length=20)),
